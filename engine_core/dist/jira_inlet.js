...
exports.runJiraIngestion = runJiraIngestion;
exports.runJiraCsvIngestion = runJiraCsvIngestion;
...
async function searchIssues(config, jql, maxResults, startAt = 0) {
...
// ── Relevance filtering ──────────────────────────────────────────
function isRelevant(issue, config) {
...
function writeToIngest(payload, issueKey) {
...
async function runJiraIngestion() {
 ...
 */
function csvRowToPayload(row, sourceFile) {
...
async function runJiraCsvIngestion(csvFilePath) {
