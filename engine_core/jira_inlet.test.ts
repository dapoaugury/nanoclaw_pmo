...
// Types replicated from jira_inlet.ts
interface JiraIssue {
    id: string;
    key: string;
    self: string;
...
function isRelevant(issue: JiraIssue, filters: FilterConfig): boolean {
...
const issueWithLabel: JiraIssue = {
...
const excludedFilters: FilterConfig = { ...defaultFilters, labels_exclude: ['feature'] };
assert(isRelevant(issueWithLabel, excludedFilters) === false, 'Issue with excluded label is not relevant');

// Test 2.4: No matches
const irrelevantIssue: JiraIssue = {
    ...issueWithLabel,
...
const projectFilters: FilterConfig = { ...defaultFilters, project_keys: ['OTHER'] };
...
const milestoneIssue: JiraIssue = {
    ...issueWithLabel,
...
const dependencyIssue: JiraIssue = {
    ...issueWithLabel,
...
const blockerBudgetIssue: JiraIssue = {
    ...issueWithLabel,
